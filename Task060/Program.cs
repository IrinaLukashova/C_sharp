...
Print3DArray(GetRandom3DArray(2,3,2)); // -- 12 элементов в массиве. сейчас сделан выбор из элементов (0,24] - если делать меньше, программа начинает медленно работать, так как ей не попасть на разные элементы рандомайзером
